<div class="container">
      <h2 class='contact'>Registruj se:</h2>
      ...
      <form action="#" method="post" id="forma">
          ...
          <input type="password" placeholder="Ponovite Password" id="tbPassword1" name="tbPassword1"><br><br>
          <input type="text" placeholder="Email" id="tbEmail" name="tbEmail"><br><br>
          <br><br><br><br>
          

          <input type="button" class="button_1" name="Salji" id="btnSalji" name="btnSalji" value="Posalji">
        </form>
        <div class="space"></div>
        <div id="ispis"></div>
      </div>
